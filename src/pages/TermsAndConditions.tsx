        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-10 text-muted-foreground font-body leading-relaxed">
            ...
            <section>
              ...
              <p className="mb-4">
                As our products are printed to order, slight variations in colour or finish may occur as part of the production process.
              </p>
              <p className="mb-4">
            ...
            <section>
              ...
              <p className="mb-4">
                If an order is changed or cancelled, we may attempt to notify you using the contact details provided at checkout.
              </p>
              <p className="mb-4">
