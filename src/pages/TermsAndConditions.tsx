        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-10 text-muted-foreground font-body leading-relaxed">
            ...
            <section>
              ...
              <p className="mb-4">
                This website is operated by <strong className="text-foreground">Terra Firma Creative</strong>. Throughout the Site, the terms "we", "us", and "our" refer to Terra Firma Creative. Terra Firma Creative offers this website, including all information, tools, and services available from <strong className="text-foreground">terrafirmacollective.com</strong> (the "Site") to you, the user, conditioned upon your acceptance of all terms, conditions, policies, and notices stated here.
              </p>
              <p className="mb-4">
            ...
            <section>
              ...
              <p className="mb-4">
                To the maximum extent permitted by law, <strong className="text-foreground">Terra Firma Creative</strong> shall not be liable for any direct, indirect, incidental, punitive, or consequential damages arising from your use of the Service or any products purchased.
              </p>
              <p className="mb-4">
            ...
            <section>
              ...
              <p>
                You agree to indemnify and hold harmless <strong className="text-foreground">Terra Firma Creative</strong> and its affiliates, partners, officers, employees, and service providers from any claim arising out of your breach of these Terms or violation of any law or third-party rights.
              </p>
            </section>
