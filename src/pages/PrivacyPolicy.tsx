      ...
      <main className="relative py-20 px-6 overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto relative z-10">
          ...
          <div className="space-y-8 text-muted-foreground font-body leading-relaxed">
            <p>
              This Privacy Policy describes how <strong className="text-foreground">Cosmic Igloo</strong> (the "Site", "we", "us", or "our") collects, uses, and discloses your personal information when you visit, use our services, or make a purchase from <strong className="text-foreground">cosmicigloo.com</strong>, or otherwise communicate with us (collectively, the "Services").
            </p>
