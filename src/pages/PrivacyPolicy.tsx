          ...
          <div className="space-y-8 text-muted-foreground font-body leading-relaxed">
            ...
            <section>
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3"><Bullet color="bg-shaman-magenta" /><span><strong className="text-foreground">Provide, Tailor, and Improve the Services.</strong> We use your personal information to provide you with the Services, including to perform our contract with you, to process your payments, to fulfill your orders, to remember your preferences and items you are interested in, to process purchases, returns, exchanges or other transactions, to arrange for shipping, and to facilitate any returns and exchanges. This may include using your personal information to better tailor and improve the Services.</span></li>
            ...
            <section className="pt-4 border-t border-border/30">
              ...
              <p>
                Should you have any questions about our privacy practices or this Privacy Policy, or if you would like to exercise any of the rights available to you, please email us at <a href={`mailto:${CONTACT_EMAIL}`} className="text-shaman-violet font-medium hover:text-shaman-violet/80 transition-colors">{CONTACT_EMAIL}</a> or contact us at {BUSINESS_ADDRESS}, AU. For the purpose of applicable data protection laws, we are the data controller of your personal information.
              </p>
            </section>
          </div>
        </div>
