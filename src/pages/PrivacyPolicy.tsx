        ...
        <div className="max-w-3xl mx-auto relative z-10">
          ...
          <div className="space-y-8 text-muted-foreground font-body leading-relaxed">
            ...
            <section className="pt-4 border-t border-border/30">
              ...
              <p>
                Should you have any questions about our privacy practices or this Privacy Policy, or if you would like to exercise any of the rights available to you, please email us at {CONTACT_EMAIL} or contact us at {BUSINESS_ADDRESS}, AU. For the purpose of applicable data protection laws, we are the data controller of your personal information.
              </p>
            </section>
          </div>
        </div>
