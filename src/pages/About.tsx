            ...
            <div>
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <span><strong className="text-foreground">Original, considered designs</strong> – Each artwork is created individually and printed edge-to-edge with precision</span>
                </li>
                <li className="flex items-start gap-3">
