        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-8 text-muted-foreground font-body leading-relaxed">
            ...
            <div>
              ...
              <p className="mb-4">
                Each design is developed through an exploratory creative process, resulting in artwork that exists nowhere else. Whether you're drawn to bold patterns, abstract forms, or calm, nature-inspired visuals, your mat becomes a personal expression of your style and energy.
              </p>
              <p>
