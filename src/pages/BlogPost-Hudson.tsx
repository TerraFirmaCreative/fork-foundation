    ...
    <div className="min-h-screen bg-background">
      <SEO
        ...
        breadcrumbs={[
          { name: "Home", path: "/" },
          { name: "Blog", path: "/blog" },
          { name: "Hudson in South West Australia", path: "/blog/hudson-in-margaret-river" },
        ]}
        jsonLd={{
          ...
          mainEntityOfPage: {
            "@type": "WebPage",
            "@id": "https://cosmicigloo.com/en-US/blog/hudson-in-margaret-river",
          },
        }}
      />
      <Header />
      ...
      <main className="relative px-6 py-20 overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto mt-16 border border-border/40 rounded-2xl bg-card/30 backdrop-blur-sm relative z-10 overflow-hidden">
          ...
          <div className="p-6 md:p-10 grid md:grid-cols-[1fr_1.4fr] gap-8 md:gap-12 items-start">
            {/* Product image */}
            <LocaleLink
