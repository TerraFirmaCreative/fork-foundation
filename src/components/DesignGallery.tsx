            ...
            {products.map((product, index) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="absolute top-1 right-1 bg-background/80 backdrop-blur-sm text-foreground text-xs md:text-sm font-body font-medium px-2 py-1 rounded-md z-10">
                    $129
                  </span>
