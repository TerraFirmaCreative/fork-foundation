      ...
      <div className="hero-marquee flex gap-2 md:gap-3 w-max motion-reduce:animate-none">
        {loop.map((p, i) => (
          <LocaleLink
            ...
            className="group relative block shrink-0 overflow-hidden rounded-lg w-[112px] h-[150px] md:w-auto md:aspect-[3/4] md:h-[min(230px,26vh)] bg-black/60 ring-1 ring-inset ring-shaman-gold/10 hover:ring-shaman-gold/50 transition-all duration-500 hover:shadow-[0_0_36px_-10px_hsl(var(--shaman-violet)/0.7)]"
          >
            <img
